...
![image](https://github.com/user-attachments/assets/d2343d04-a768-4cb6-8f43-40e0fc0696db)

จากการทดลองพบว่า Task1 สร้าง queue ส่งข้อความ 3 ข้อความผ่าน queue โดยแต่ละข้อความจะถูกจัดเก็บใน queue เข้าสู่ลูปไม่รู้จบและมีการหน่วงเวลา 1 วินาทีในแต่ละรอบ Task2 รอรับข้อมูลจาก queue เมื่อได้รับข้อมูลจาก queue แสดงผลผ่าน monitor
